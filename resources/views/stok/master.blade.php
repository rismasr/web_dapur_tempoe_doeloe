...
<body>
      ...
      <div class="main-content">
        ...
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item active"><a href="#">Stok Menu</a></div>
            </div>
          </div>
  ...
  function functionDelete(url){
        swal({
          title: 'Apakah anda yakin akan menghapus Menu?',
          type: 'warning',
          ...
          buttonsStyling: false
            ...
            swal("Dihapus!", "Data Menu Telah Dihapus!", "success");
            window.location = url;
        }, function (dismiss) {
