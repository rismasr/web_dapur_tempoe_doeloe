<div class="main-sidebar">
  <aside id="sidebar-wrapper">
    ...
    <li class="menu-header">Dashboard</li>
        <li><a class="nav-link" href="{{URL::to('/')}}/"><i class="fas fa-fire"></i> <span>Dashboard</span></a></li>
        ...
        <li ><a class="nav-link" href="{{URL::to('/')}}/role"><i class="far fa-user"></i> <span>Kelola Role</span></a></li>
        ...
        <li class="active"><a class="nav-link" href="{{URL::to('/')}}/terlaris"><i class="fas fa-table"></i> <span>Menu Terlaris</span></a></li>
        @endcan
        @can('isDapur')
