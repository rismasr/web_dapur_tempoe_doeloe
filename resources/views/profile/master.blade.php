...
<body>
  ...
  function functionUpdate(url){
        swal({
          title: 'Apakah anda yakin akan meng-update status Transaksi?',
          text: "Jika status di-update, maka status transaksi akan berubah & otomatis dikirimkan ke customer",
          type: 'warning',
          ...
          buttonsStyling: false
            ...
            swal("Diupdate!", "Status Transaksi Telah Di-Update!", "success");
            window.location = url;
        }, function (dismiss) {
          // dismiss can be 'cancel', 'overlay',
          // 'close', and 'timer'
          if (dismiss === 'cancel') {
            swal("Cancelled", "Status Transaksi tidak jadi di-update", "error")
          }
        })
    }  
  </script>
