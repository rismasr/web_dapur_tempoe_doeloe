...
<body>
      ...
      <div class="main-content">
        ...
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item active"><a href="#">Meja</a></div>
            </div>
          </div>
  ...
  function functionDelete(url){
        swal({
          title: 'Apakah anda yakin akan menghapus Meja?',
          type: 'warning',
          ...
          buttonsStyling: false
            ...
            swal("Dihapus!", "Data Meja Telah Dihapus!", "success");
            window.location = url;
        }, function (dismiss) {
          // dismiss can be 'cancel', 'overlay',
          // 'close', and 'timer'
          if (dismiss === 'cancel') {
            swal("Cancelled", "Data Meja tidak jadi dihapus", "error")
          }
        })
    }  
  </script>
