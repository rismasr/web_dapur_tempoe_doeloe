...
<body>
  <div id="app">
    <div class="main-wrapper">
      ...
      @include('grafik_menu_terlaris.header')
      @include('grafik_menu_terlaris.sidebar')
      ...
      <div class="main-content">
        ...
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item active"><a href="#">Grafik</a></div>
            </div>
          </div>
  ...
  function functionDelete(url){
        swal({
          title: 'Apakah anda yakin akan menghapus Poduct?',
          text: "Jika data di hapus, maka data akan terhapus & akan masuk ke menu trash",
          type: 'warning',
          ...
          buttonsStyling: false
            ...
            swal("Dihapus!", "Data Product Telah Dihapus!", "success");
            window.location = url;
        }, function (dismiss) {
          // dismiss can be 'cancel', 'overlay',
          // 'close', and 'timer'
          if (dismiss === 'cancel') {
            swal("Cancelled", "Data Product tidak jadi dihapus", "error")
          }
        })
    }  
  </script>
  ...
  <script type="text/javascript">
    var menu_terjual =  <?php echo json_encode($menu_terjual) ?>;

    var nama_menu =  <?php echo json_encode($nama_menu) ?>;
   
    Highcharts.chart('content_grafikmenuterlaris', {
        title: {
            text: 'Diagram Batang Menu Terlaris'
        },
        subtitle: {
            text: 'Tahun 2021'
        },
         xAxis: {
            categories: nama_menu
        },
        yAxis: {
            title: {
