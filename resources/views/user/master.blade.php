...
<body>
    ...
    <div class="main-wrapper">
      ...
      <footer class="main-footer">
        <div class="footer-left">
          Copyright &copy; 2021 <div class="bullet"></div> Created By <a href="">Dapoer Tempo Doeloee</a>
        </div>
  ...
  function functionDelete(url){
        swal({
          title: 'Apakah anda yakin akan menghapus Users?',
          type: 'warning',
          ...
          buttonsStyling: false
            ...
            swal("Dihapus!", "Data Users Telah Dihapus!", "success");
            window.location = url;
        }, function (dismiss) {
          // dismiss can be 'cancel', 'overlay',
          // 'close', and 'timer'
          if (dismiss === 'cancel') {
            swal("Cancelled", "Data Menu tidak jadi dihapus", "error")
          }
        })
    }  
  </script>
