                  ...
                  <div class="card-body">
                    ...
                    @foreach ($transaksi as $value)
                      ...
                      @endif
                        ...
                        <form id="approve-{{ $value->id }}" action="{{ route('transaksi_baru.approve', $value->id) }}" method="post" style="display:none;">
                          @csrf
                          @method('POST')
                        ...
                        <form id="tolak-{{ $value->id }}" action="{{ route('transaksi_baru.tolak', $value->id) }}" method="post" style="display:none;">
                          @csrf
                          @method('POST')
                          <input type="hidden" name="id" value="{{ $value->id }}">
                        ...
                        <form id="selesai-{{ $value->id }}" action="{{ route('transaksi_baru.selesai', $value->id) }}" method="post" style="display:none;">
                          @csrf
                          @method('POST')
                          <input type="hidden" name="id" value="{{ $value->id }}">
